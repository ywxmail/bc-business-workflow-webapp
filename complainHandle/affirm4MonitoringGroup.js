...
bswf.carTrafficHandle.examinationAndapprovalForm = {
	init : function(option,readonly){
		var $form = $(this);
		
		//是否送相关部门协办的处理方式事件
		$form.find("input[type='checkbox'][name='isDcFlow']").change(function(){

			$rhandings=$form.find("input[type='checkbox'][name='isDcFlow']");
			var checked=false;
			var value;
	...
	validateForm: function(){
		...
		bswf.carTrafficHandle.examinationAndapprovalForm.buildFormData.call(this);
