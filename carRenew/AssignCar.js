		...
		$form.find("#addCar").click(function() {
			bs.selectCar({
				...
				onOk : function(car) {
					...
					$form.find(":input[name='factoryType_gl']").val(car.factoryType);
					...
					$form.find(":input[name='accessCount']").val(car.accessCount);
					$form.find(":input[name='accessCount_gl']").val(car.accessCount);
